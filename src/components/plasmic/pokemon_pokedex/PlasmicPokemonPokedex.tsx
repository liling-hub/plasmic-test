...
// Plasmic Project: gXjBkcTC9EtHWY9AmrTnar
// Component: nR-VqFpMB0lx
...
import PageLayout from "../../PageLayout"; // plasmic-import: DW6f5Qfomb4j/component
...
import projectcss from "./plasmic.module.css"; // plasmic-import: gXjBkcTC9EtHWY9AmrTnar/projectcss
import sty from "./PlasmicPokemonPokedex.module.css"; // plasmic-import: nR-VqFpMB0lx/css
...
function PlasmicPokemonPokedex__RenderFunc(props: {
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    getPokemon: usePlasmicDataOp(() => {
      return {
        sourceId: "2TbSuK23B29oo3VvCkGiHR",
        opId: "a1c31978-47c6-4b76-860b-4fb9f03f515b",
        userArgs: {},
        cacheKey: `plasmic.$.a1c31978-47c6-4b76-860b-4fb9f03f515b.$.`,
            ...
            <DataCtxReader__>
              {$ctx => (
                <React.Fragment>
                  ...
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__r6Ho)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
                        ...
                        $steps["useIntegration"] = true
                          ? (() => {
                              const actionArgs = {
                                dataOp: {
                                  sourceId: "2TbSuK23B29oo3VvCkGiHR",
                                  opId: "15e8831e-3d86-494a-9bf5-46389597b25d",
                                  userArgs: {
                  ...
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__oLz6)}
                    >
                      {(() => {
                        const child$Props = {
                          ...
                          data: {
                            sourceId: "2TbSuK23B29oo3VvCkGiHR",
                            opId: "88df6d4f-4314-4b3c-9e4b-dafef992491f",
                            userArgs: {},
                            cacheKey: `plasmic.$.${(() => {
                              try {
                                return "getSchema";
                            ...
                            })()}.$.mgnpj3Wykhlx.$.88df6d4f-4314-4b3c-9e4b-dafef992491f.$.`,
                            invalidatedKeys: null,
                            roleId: null
                          },
                          dataFormItems: (() => {
                            ...
                            $steps["defaultSubmit"] = true
                              ? (() => {
                                  const actionArgs = {
                                    dataOp: {
                                      sourceId: "2TbSuK23B29oo3VvCkGiHR",
                                      opId: "b418aef5-ccf5-4f93-90ec-77d62a5d4ca0",
                                      userArgs: {
                  ...
                  <AntdModal
                      ...
                      $steps["postgresUpdateMany"] = true
                        ? (() => {
                            const actionArgs = {
                              dataOp: {
                                sourceId: "2TbSuK23B29oo3VvCkGiHR",
                                opId: "eb3835ab-893e-4b8c-acac-366eb4b779ab",
                                userArgs: {
                    ...
                    wrapClassName={classNames({
                      [sty["pcls_lWfYDJ-7C93X"]]: true
                    })}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__ybpQu)}
                    >
                      {(() => {
                        const child$Props = {
                          className: classNames(
                          ...
                          data: {
                            sourceId: "2TbSuK23B29oo3VvCkGiHR",
                            opId: "a1cb24d7-f667-4fbe-984d-bcb92c39c053",
                            userArgs: {
                            ...
                            })()}.$.E99cz1qCpHd9.$.a1cb24d7-f667-4fbe-984d-bcb92c39c053.$.`,
                            invalidatedKeys: null,
                            roleId: null
                          },
                          dataFormItems: (() => {
